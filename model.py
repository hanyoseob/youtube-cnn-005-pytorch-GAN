...
class DCGAN(nn.Module):
    def __init__(self, in_channels, out_channels, nker=128, norm="bnorm"):
        ...
        self.dec5 = DECBR2d(1 * in_channels,    8 * nker,       kernel_size=4, stride=1, padding=0, norm=norm, relu=0.0)
        self.dec4 = DECBR2d(8 * nker,           4 * nker,       kernel_size=4, stride=2, padding=1, norm=norm, relu=0.0)
        self.dec3 = DECBR2d(4 * nker,           2 * nker,       kernel_size=4, stride=2, padding=1, norm=norm, relu=0.0)
        self.dec2 = DECBR2d(2 * nker,           1 * nker,       kernel_size=4, stride=2, padding=1, norm=norm, relu=0.0)
...
class Discriminator(nn.Module):
    def __init__(self, in_channels, out_channels, nker=128, norm="bnorm"):
        ...
        self.dsc1 = CBR2d(1 * in_channels,  1 * nker,       kernel_size=4, stride=2, padding=1, norm=norm, relu=0.2)
        self.dsc2 = CBR2d(1 * nker,         2 * nker,       kernel_size=4, stride=2, padding=1, norm=norm, relu=0.2)
        self.dsc3 = CBR2d(2 * nker,         4 * nker,       kernel_size=4, stride=2, padding=1, norm=norm, relu=0.2)
        self.dsc4 = CBR2d(4 * nker,         8 * nker,       kernel_size=4, stride=2, padding=1, norm=norm, relu=0.2)
